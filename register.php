<?php 
    ...
    if (isset($_POST['register'])) {
        ...
        if (!empty(trim($email)) && !empty(trim($pass))) {
            $insert = mysqli_query($conn, "INSERT INTO  login (email,password) values ('$email','$pass')");
            if ($insert) {
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="form-group mt-4 mb-0">
                                                <button class="btn btn-primary btn-block" href="login.html" name="register">Create Account</button>
                                            </div>
                                        </form>
                                    </div>
